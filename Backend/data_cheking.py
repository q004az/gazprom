...
def is_correct_data_user(surname: str, name: str, patronymic: str, login: str, password: str)-> bool, {'surname' : bool, 'name' : bool, patronymic : bool, login : bool, password : bool}
